...
istring = istring.replace('def', 'function')
istring = istring.replace('\n        ', ';\n    ')
istring = istring.replace('\n\n', ';\n}\n\n')
istring = istring.replace(':;', ' {')

neurons = re.findall("'([^']*)'", istring)
neurons = list(set(neurons))
for n in neurons:
    istring = istring.replace("'" + n + "'", "neurons.indexOf(" + "'" + n + "'" + ")")

with open("translation.js", "w") as text_file:
    text_file.write(istring)
